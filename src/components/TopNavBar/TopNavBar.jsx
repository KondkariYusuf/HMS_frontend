...
const SunIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M19.0708 4.92896L17.6566 6.34317" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    <path d="M6.34326 17.6569L4.92905 19.0711" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    <path d="M19.0708 19.071L17.6566 17.6568" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
    <path d="M6.34326 6.34314L4.92905 4.92893" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);

const BellIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M18 16V10C18 6.68629 15.3137 4 12 4C8.68629 4 6 6.68629 6 10V16H18Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/>
    <path d="M10 20C10.5523 20.8954 11.2386 21.5 12 21.5C12.7614 21.5 13.4477 20.8954 14 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
...
export default function TopNavBar({
      ...
      <header className={styles.header} data-testid="top-nav-bar">
        <div className={styles.leftSection}>
          <div className={styles.billingTitle}>
            <span className={styles.brandPrimary}>HospitalityOS</span>
            <span className={styles.separator}>|</span>
            <span className={styles.pageTitleDark}>Billing & Invoices</span>
          </div>
        </div>
  ...
  if (isMaintenance) {
    return (
      <header className={styles.header} data-testid="top-nav-bar">
        <div className={styles.leftSection}>
          <h2 className={styles.brandPrimaryHeading}>Grand Horizon</h2>
