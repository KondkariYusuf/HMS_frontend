...
const Icon = ({ name }) => {
  switch (name) {
    case 'dashboard':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="2" y="2" width="5" height="5" rx="1" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
          <rect x="9" y="2" width="5" height="5" rx="1" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
          <rect x="2" y="9" width="5" height="5" rx="1" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
          <rect x="9" y="9" width="5" height="5" rx="1" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"/>
        </svg>
      );
    case 'calendar':
      return (
    ...
    case 'bed':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2 13V5C2 3.89543 2.89543 3 4 3H12C13.1046 3 14 3.89543 14 5V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M2 10H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M5 7H7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    case 'users':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M1 14C1 11.5147 3.01472 9.5 5.5 9.5C7.98528 9.5 10 11.5147 10 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <circle cx="11.5" cy="6.5" r="2" stroke="currentColor" strokeWidth="1.5"/>
          <path d="M14.5 14C14.5 12.067 12.933 10.5 11 10.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      );
    case 'bar-chart':
      return (
    ...
    case 'gear':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M8 2V3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M8 12.5V14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M3.75732 3.75732L4.81802 4.81802" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M11.1821 11.1816L12.2428 12.2423" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M2 8H3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M12.5 8H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M3.75732 12.2427L4.81802 11.182" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M11.1821 4.81836L12.2428 3.75766" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      );
    case 'wrench':
      return (
    ...
    case 'chart-line':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M2 14V2" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M2 14H14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M4 10L7 6L9 8L13 3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      );
    case 'help':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M8 11.5V11.4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M8 9.5C8 9.5 9.5 9 9.5 7.5C9.5 6 8.5 5 7.5 5C6.5 5 6 6.5 6 6.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      );
    case 'logout':
      return (
...
export default function SideNavBar() {
  ...
  const isBilling = location.pathname.startsWith('/settings/billing-invoices');
  const isMaintenance = location.pathname.startsWith('/maintenance');

  const billingItems = [
    { path: '/', label: 'Dashboard', icon: 'dashboard' },
    { path: '/hotel/reservations', label: 'Reservations', icon: 'calendar' },
    { path: '/hotel/rooms', label: 'Rooms', icon: 'bed' },
    { path: '/staff', label: 'Staff', icon: 'users' },
    { path: '/billing/reports', label: 'Reports', icon: 'bar-chart' },
    { path: '/settings/billing-invoices', label: 'Settings', icon: 'gear' },
  ];
    ...
    if (isMaintenance) {
      return (
        <div className={styles.brandBlock}>
          <h1 className={styles.brandTitle}>Grand Horizon</h1>
          <span className={styles.brandSubtitle}>HOTEL OPERATIONS</span>
        </div>
      );
    }
    return (
  ...
  const renderNavItems = () => {
    if (isBilling || isMaintenance) {
      const items = isBilling ? billingItems : maintenanceItems;
      return (
  ...
  const renderFooter = () => {
    if (isBilling) {
      return (
        <div className={styles.footerBlock}>
          <a href="https://support.example.com" target="_blank" rel="noreferrer" className={styles.footerLink}>
            <span className={styles.navIcon}><Icon name="help" /></span> Support
          </a>
          <NavLink to="/login" className={styles.footerLink}>
            <span className={styles.navIcon}><Icon name="logout" /></span> Log Out
          </NavLink>
        </div>
      );
    }
    if (isMaintenance) {
      return (
        <div className={styles.footerBlock}>
          <a href="https://support.example.com" target="_blank" rel="noreferrer" className={styles.footerLink}>
            <span className={styles.navIcon}><Icon name="help" /></span> Help Center
          </a>
          <NavLink to="/login" className={styles.footerLink}>
            <span className={styles.navIcon}><Icon name="logout" /></span> Logout
          </NavLink>
        </div>
      );
    }
