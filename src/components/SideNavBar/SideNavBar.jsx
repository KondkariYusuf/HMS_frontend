...
const Icon = ({ name }) => {
  switch (name) {
    ...
    case 'bed':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          ...
          <path d="M5 7H7" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      );
    ...
    case 'gear':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          ...
          <path d="M3.75732 3.75732L4.81802 4.81802" stroke="currentColor" strokeWidth="1.5" />
          <path d="M11.1821 11.1816L12.2428 12.2423" stroke="currentColor" strokeWidth="1.5" />
          ...
          <path d="M3.75732 12.2427L4.81802 11.182" stroke="currentColor" strokeWidth="1.5" />
          <path d="M11.1821 4.81836L12.2428 3.75766" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      );
    ...
    case 'chart-line':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          <path d="M2 14V2" stroke="currentColor" strokeWidth="1.5" />
          <path d="M2 14H14" stroke="currentColor" strokeWidth="1.5" />
          <path d="M4 10L7 6L9 8L13 3" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      );
    ...
    case 'help':
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          ...
          <path d="M8 11.5V11.4" stroke="currentColor" strokeWidth="1.5" />
          <path
      ...
      return (
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <path d="M13 8H6" stroke="currentColor" strokeWidth="1.5" />
        </svg>
      );
